  <nav x-data="{ open: false }" class="bg-gray-800">
          ...
          <div class="flex h-16 items-center justify-between">
              ...
              <div class="-mr-2 flex md:hidden">
                  ...
                  <button type="button" @click="open = !open"
                      ...
                      <svg x-bind:class="open ? 'hidden' : 'block'" class="size-6" fill="none" viewBox="0 0 24 24"
                          stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
                          <path stroke-linecap="round" stroke-linejoin="round"
                              d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                      </svg>
                      <!-- Menu open: "block", Menu closed: "hidden" -->
                      <svg x-bind:class="open ? 'block' : 'hidden'" class="size-6" fill="none" viewBox="0 0 24 24"
                          stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
      ...
      <div class="md:hidden" x-show="open" id="mobile-menu">
          ...
          <div class="border-t border-gray-700 pt-4 pb-3">
              ...
              <div id="menuProfilMobile" class="mt-3 d-none space-y-1 px-2">
                  <a href="#"
